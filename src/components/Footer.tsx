        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#hero" className="text-gray-400 hover:text-yellow-400 transition-colors duration-300 text-sm">Beranda</a></li>
              <li><a href="#about" className="text-gray-400 hover:text-yellow-400 transition-colors duration-300 text-sm">Tentang Acara</a></li>
              <li><a href="#competitions" className="text-gray-400 hover:text-yellow-400 transition-colors duration-300 text-sm">Jenis Lomba</a></li>
              <li><a href="#schedule" className="text-gray-400 hover:text-yellow-400 transition-colors duration-300 text-sm">Jadwal & Lokasi</a></li>
              <li><a href="#documentation" className="text-gray-400 hover:text-yellow-400 transition-colors duration-300 text-sm">Dokumentasi</a></li>
              <li><a href="#support" className="text-gray-400 hover:text-yellow-400 transition-colors duration-300 text-sm">Dukung Kami</a></li>
            </ul>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs">RT III, Kec. Rappocini, Makassar</p>
                </div>
              </div>
