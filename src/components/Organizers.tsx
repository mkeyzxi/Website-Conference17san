      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Tim yang bertanggung jawab atas suksesnya penyelenggaraan perayaan
            HUT RI ke-80 di RT III Karema Utara
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {organizers.map((organizer, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${organizer.bgColor} rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                ></div>
                <div className="relative z-10">
                  <div
                    className={`w-16 h-16 bg-gradient-to-br ${organizer.bgColor} rounded-xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform duration-300`}
                  >
                    <IconComponent
                      className={`w-8 h-8 ${organizer.iconColor}`}
                    />
                  </div>
        ...
        >
          <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-8 border border-gray-700">
            <h3 className="text-2xl font-bold text-white mb-4">
              Mari Bersama Sukseskan Acara Ini
            </h3>
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Dengan dukungan dan partisipasi aktif dari seluruh warga, mari
              kita wujudkan perayaan kemerdekaan yang meriah dan berkesan.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                className="bg-transparent border-2 border-yellow-500 text-yellow-500 hover:bg-yellow-500 hover:text-black px-6 py-3 rounded-xl font-semibold transition-all duration-300"
                onClick={() =>
                  window.open(
                    "https://drive.google.com/file/d/1KqeqMHgUYhMQ0YHt7SqWG6UnRv3ZE_DH/view?usp=sharing",
                    "_blank",
                  )
                }
              >
