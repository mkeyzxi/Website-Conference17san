      ...
      <div className="max-w-7xl mx-auto px-4">
          ...
          {competitions.map((competition, index) => {
            ...
            return (
              ...
              >
                ...
                <div className={`absolute inset-0 bg-gradient-to-br ${competition.bgColor} rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300`}></div>
                ...
                <div className="relative z-10">
                  ...
                  {/* <div className="mt-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <button className={`w-full py-2 px-4 rounded-lg ${competition.iconColor.replace('text-', 'bg-').replace('-500', '-600')} hover:${competition.iconColor.replace('text-', 'bg-').replace('-500', '-700')} text-white font-semibold text-sm transition-colors duration-300`}>
                      Daftar Sekarang
                    </button>
                  </div> */}
                </div>
                ...
                {/* Decorative elements */}
                <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-bl from-white/5 to-transparent rounded-tr-2xl"></div>
                <div className="absolute bottom-0 left-0 w-16 h-16 bg-gradient-to-tr from-white/5 to-transparent rounded-bl-2xl"></div>
              </div>
            );
          })}
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-gray-800 to-gray-700 rounded-2xl p-8 border border-gray-600">
            ...
            <div className="mt-6">
              <button className="bg-red-600 hover:bg-red-700 text-white px-8 py-3 rounded-xl font-semibold transition-colors duration-300">
                Daftar Sekarang
              </button>
            </div>
          </div>
