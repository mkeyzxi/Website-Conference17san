  ...
  const competitions = [
    {
      ...
      icon: Trophy,
      description:
        "Lomba tradisional panjat pinang yang menguji kekompakan tim",
    ...
    },
    {
      ...
      icon: Wind,
      description:
        "Lomba estafet menggunakan tepung yang menguji koordinasi tim",
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-300 text-lg max-w-3xl mx-auto">
            Berbagai lomba tradisional dan modern yang akan memeriahkan perayaan
            HUT RI ke-80. Mari berpartisipasi dan tunjukkan semangat
            sportivitas!
          </p>
        </motion.div>
          ...
          {competitions.map((competition, index) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${competition.bgColor} rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                />

                <div className="relative z-10">
                  {/* Icon */}
                  <div
                    className={`w-16 h-16 bg-gradient-to-br ${competition.bgColor} rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}
                  >
                    <IconComponent
                      className={`w-8 h-8 ${competition.iconColor}`}
                    />
                  </div>
        ...
        >
          <div className="bg-gradient-to-r from-gray-800 to-gray-700 rounded-2xl p-8 border border-gray-600">
            ...
            <div className="mt-6">
              <button
                className="bg-red-600 hover:bg-red-700 text-white px-8 py-3 rounded-xl font-semibold transition-colors duration-300"
                onClick={() =>
                  window.open(
                    "https://wa.me/6285342181132?text=Halo,%20saya%20ingin%20mendaftar%20lomba%20HUT%20RI%2080",
                    "_blank",
                  )
                }
              >
